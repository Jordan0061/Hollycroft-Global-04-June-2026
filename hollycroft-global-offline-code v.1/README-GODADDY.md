...
The Make webhook receives the values as URL query parameters from the Netlify Function. This avoids Make treating any request body as one raw value. The function also sends machine-safe backup aliases:
...
If Make does not show the spaced labels clearly, map the machine-safe aliases instead.
